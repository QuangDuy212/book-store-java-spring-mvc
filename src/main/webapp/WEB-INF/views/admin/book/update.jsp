                                        ...
                                        <div class="pd-20 card-box height-100-p">
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img id="updateBookPre" class="avatar-photo"
                                                    ...
                                                    <li class="weight-500 col-md-12">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <input class="form-control-file form-control height-auto"
                                                                type="file" id="updateBookFile"
                                                                accept=".png, .jpg, .jpeg" name="updateBookFile" />
                                                        </div>
                    ...
                    <script>
                        $(document).ready(() => {
                            ...
                            if (bookImg != "") {
                                ...
                                $("#updateBookPre").attr("src", imgURL);
                                $("#updateBookPre").css({ "display": "block" });
                            } else {
                                $("#updateBookPre").css({ "display": "none" });

                            }
                            updateBookFile.change(function (e) {
