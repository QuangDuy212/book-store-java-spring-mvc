                                ...
                                <div class="browser-visits">
                                    <ul>
                                        <li class="d-flex flex-wrap align-items-center">
                                            <div class="icon">
                                                <img src="/admin/vendors/images/chrome.png" alt="" />
                                            </div>
                                        ...
                                        <li class="d-flex flex-wrap align-items-center">
                                            <div class="icon">
                                                <img src="/admin/vendors/images/firefox.png" alt="" />
                                            </div>
                                        ...
                                        <li class="d-flex flex-wrap align-items-center">
                                            <div class="icon">
                                                <img src="/admin/vendors/images/safari.png" alt="" />
                                            </div>
                                        ...
                                        <li class="d-flex flex-wrap align-items-center">
                                            <div class="icon">
                                                <img src="/admin/vendors/images/edge.png" alt="" />
                                            </div>
                                        ...
                                        <li class="d-flex flex-wrap align-items-center">
                                            <div class="icon">
                                                <img src="/admin/vendors/images/opera.png" alt="" />
                                            </div>
