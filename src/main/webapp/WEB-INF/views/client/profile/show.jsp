    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <body>
                                    ...
                                    <div class="pd-20 card-box height-100-p">
                                        <div
                                            ...
                                            <div style="width: 100px; height: 100px; border-radius: 50%; ">
                                                <img id="avatarProfilePreClient" class="avatar-photo"
                                                                    ...
                                                                    <li class="weight-500 col-md-12">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                type="file" id="avatarUpdateFileClient"
                                                                                accept=".png, .jpg, .jpeg"
                                                                                name="avatarUpdateFileClient" />
                                                                        </div>
                ...
                <script>
                    $(document).ready(() => {
                        const avatarFile = $("#avatarUpdateFileClient");
                        const avatarImg = "${newUser.avatar}";
                        if (avatarImg) {
                            const imgURL = "/images/avatar/" + avatarImg;
                            $("#avatarUpdatePreClient").attr("src", imgURL);
                            $("#avatarProfilePreClient").attr("src", imgURL);
                        }
                        else {
                            $("#avatarUpdatePreClient").attr("src", "/images/avatar/default-avatar.webp");
                            $("#avatarProfilePreClient").attr("src", "/images/avatar/default-avatar.webp");
                        }
